...
int main() {
    ...
    glm::vec4 sample_data (0.125f, 0.333f, 0.6547f, 0.111674f);
    uint32_t  packed_sample_data = glm::packUnorm4x8(sample_data);
    glm::vec4 unpack_sample_data = glm::unpackUnorm4x8(packed_sample_data);
