%VULKAN_SDK%/bin/glslc.exe shaders/gbuffer.vert -o shaders/particle_gbuffer.vert.spv
%VULKAN_SDK%/bin/glslc.exe shaders/gbuffer.frag -o shaders/particle_gbuffer.frag.spv
...
%VULKAN_SDK%/bin/glslc.exe shaders/particle.comp -o shaders/particle.comp.spv